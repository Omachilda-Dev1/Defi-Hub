...
export default function Farm() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-black dark:text-white mb-2">Yield Farming</h1>
        <p className="text-gray-600 dark:text-gray-400">Stake LP tokens to earn DGT rewards</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
          ...
          <p className="text-2xl font-bold text-black dark:text-white">{farmData.totalStaked} LP</p>
        </div>
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
          <h3 className="text-sm text-gray-600 dark:text-gray-400 mb-2">APY</h3>
          <p className="text-2xl font-bold text-green-600 dark:text-green-400">{farmData.apy}%</p>
        </div>
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
          <h3 className="text-sm text-gray-600 dark:text-gray-400 mb-2">Rewards Per Block</h3>
          <p className="text-2xl font-bold text-black dark:text-white">{farmData.rewardPerBlock} DGT</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
          <h2 className="text-xl font-bold text-black dark:text-white mb-6">Stake LP Tokens</h2>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
            <h2 className="text-xl font-bold text-black dark:text-white mb-6">Rewards</h2>
            
            <div className="bg-gradient-to-r from-primary/20 to-primary/10 rounded-lg p-6 mb-4 border border-primary/30">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Pending Rewards</p>
              <p className="text-3xl font-bold text-black dark:text-white mb-4">{farmData.pendingRewards} DGT</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">${farmData.pendingRewardsUSD} USD</p>
            </div>

            <button
              onClick={handleHarvest}
              disabled={!isConnected || farmData.pendingRewards === '0.00' || loading}
              className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-400 dark:disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition-colors"
            >
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800 transition-colors">
            <h2 className="text-xl font-bold text-black dark:text-white mb-6">Unstake</h2>
            
            <div className="space-y-4">
              <div className="bg-white dark:bg-black rounded-lg p-4 border border-gray-300 dark:border-gray-700 transition-colors">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Amount to Unstake</span>
                  <span className="text-sm text-gray-600 dark:text-gray-400">Staked: {farmData.stakedAmount}</span>
                </div>
                <div className="flex items-center space-x-4">
                  <input
                    type="text"
              ...
              <button
                ...
                className="w-full bg-red-600 hover:bg-red-700 disabled:bg-gray-400 dark:disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition-colors"
              >
